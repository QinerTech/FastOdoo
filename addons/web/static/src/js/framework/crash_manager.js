...
var CrashManager = core.Class.extend({
    ...
    show_warning: function(error) {
        ...
        new Dialog(this, {
            size: 'medium',
//Qiner,20160708, change the warning title
            title: "QinerERP " + (_.str.capitalize(error.type) || _t("Warning")),
    ...
    show_error: function(error) {
        ...
        new Dialog(this, {
            title: "QinerERP " + _.str.capitalize(error.type),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "QinerERP " + (_.str.capitalize(error.type) || "Warning"),
            buttons: [
